...
class Site extends CI_Controller {
	...
	function angels_of_anaheim() {
		...
		$this -> load -> model('sportsfeed');
		$data['entries'] = $this -> sportsfeed -> angels_of_anaheim();
		$this -> load -> view("home", $data);
	}
	...
	function oakland_athletics() {
		...
		$this -> load -> model('sportsfeed');
		$data['entries'] = $this -> sportsfeed -> oakland_athletics();
		$this -> load -> view("home", $data);
	}	
	...
	function toronto_blue_jays() {
		...
		$this -> load -> model('sportsfeed');
		$data['entries'] = $this -> sportsfeed -> toronto_blue_jays();
		$this -> load -> view("home", $data);
	}	
	...
	function tampa_bay_rays() {
		...
		$this -> load -> model('sportsfeed');
		$data['entries'] = $this -> sportsfeed -> tampa_bay_rays();
		$this -> load -> view("home", $data);
	}	
	...
	function cleveland_indians() {
		...
		$this -> load -> model('sportsfeed');
		$data['entries'] = $this -> sportsfeed -> cleveland_indians();
		$this -> load -> view("home", $data);
	}	
	...
	function seattle_mariners() {
		...
		$this -> load -> model('sportsfeed');
		$data['entries'] = $this -> sportsfeed -> seattle_mariners();
		$this -> load -> view("home", $data);
	}	
	...
	function baltimore_orioles() {
		...
		$this -> load -> model('sportsfeed');
		$data['entries'] = $this -> sportsfeed -> baltimore_orioles();
		$this -> load -> view("home", $data);
	}	
	...
	function texas_rangers() {
		...
		$this -> load -> model('sportsfeed');
		$data['entries'] = $this -> sportsfeed -> texas_rangers();
		$this -> load -> view("home", $data);
	}
	...
	function boston_red_sox() {
		...
		$this -> load -> model('sportsfeed');
		$data['entries'] = $this -> sportsfeed -> boston_red_sox();
		$this -> load -> view("home", $data);
	}
	...
	function kansas_city_royals() {
		...
		$this -> load -> model('sportsfeed');
		$data['entries'] = $this -> sportsfeed -> kansas_city_royals();
		$this -> load -> view("home", $data);
	}
	...
	function detroit_tigers() {
		...
		$this -> load -> model('sportsfeed');
		$data['entries'] = $this -> sportsfeed -> detroit_tigers();
		$this -> load -> view("home", $data);
	}
	...
	function minnesota_twins() {
		...
		$this -> load -> model('sportsfeed');
		$data['entries'] = $this -> sportsfeed -> minnesota_twins();
		$this -> load -> view("home", $data);
	}	
	...
	function chicago_white_sox() {
		...
		$this -> load -> model('sportsfeed');
		$data['entries'] = $this -> sportsfeed -> chicago_white_sox();
		$this -> load -> view("home", $data);
	}
	...
	function new_york_yankees() {
		...
		$this -> load -> model('sportsfeed');
		$data['entries'] = $this -> sportsfeed -> new_york_yankees();
		$this -> load -> view("home", $data);
	}
	...
	function houston_astros() {
		...
		$this -> load -> model('sportsfeed');
		$data['entries'] = $this -> sportsfeed -> houston_astros();
		$this -> load -> view("home", $data);
	}
