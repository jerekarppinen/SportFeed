...
class Register extends CI_Controller {
	...
	function index()
	{
		$this->form_validation->set_rules('username', 'trim|required|alpha_numeric|min_length[4]|xss_clean|is_unique[users.username]');
		...
		$this->form_validation->set_rules('password_conf', '|required|matches[password]|xss_clean');
