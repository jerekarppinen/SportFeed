...
<div id="header"> 
	...
	<ul id="navbox" class="clearfix">
		<li class="mlb">
			<a class="navlink" data-url="<?php echo base_url();?>index.php/site/index/mlb" ng-click="getFeed($event)">+ MLB -</a>
				...
				<ul ng-repeat="conference in mlb.conferences" class="conferenceholder">
					...
					<li class="divisionsholder clearfix">
						<ul ng-repeat="division in conference.divisions" class="divisions">
							...
							<li ng-repeat="item in division.teams" class="teamname">
								<a class="navsublink" data-url="<?php echo base_url();?>{{item.url}}" ng-click="getFeed($event)">+ {{item.team}} -</a>
							</li>
						</ul>
					</li>
				</ul>
		...
		<li class="nfl">
			<a class="navlink" data-url="<?php echo base_url();?>index.php/site/index/nfl" ng-click="getFeed($event)">NFL</a>
			<div class="teamscontainer">
		...
		<li class="nba">
			<a class="navlink" data-url="<?php echo base_url();?>index.php/site/index/nba" ng-click="getFeed($event)">NBA</a>
			<div class="teamscontainer">
		...
		<li class="nhl">
			<a class="navlink" data-url="<?php echo base_url();?>index.php/site/index/nhl" ng-click="getFeed($event)">NHL</a>
			<div class="teamscontainer">
